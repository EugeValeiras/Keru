...
| **CatálogoCertificación** *(KER-52)* | catálogo **finito seedeado por migración** (patrón `range_version`): `key`, nombre visible, **insignia** (ícono) | referenciado por Certificación (`catalogKey`) |
