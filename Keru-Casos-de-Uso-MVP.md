...
| **Alerta / Notificación** | tipo (signo fuera de rango / novedad / evento de contratación — cancelación o no-show, UC-09 A3/A4), métrica, valor, **versión de rango aplicada** (NFR-28), fecha/hora, destinatarios, estado leída/no leída | Paciente → Familiares (o contraparte de la contratación); vive en el centro de notificaciones (campana) |
