...
|---|---|---|
| **Usuario (Cuenta)** | credenciales, **email verificado (`emailVerified`; el self-signup arranca en `false` hasta confirmar el link, UC-04 A5)**, rol (paciente / familiar / cuidador / admin) | 1..n Perfiles de Paciente administrados (UC-22, para cuentas paciente/familiar) |
