...
- 📘 **Fuente de verdad de producto (casos de uso):** [`Keru-Casos-de-Uso-MVP.md`](./Keru-Casos-de-Uso-MVP.md)
- 📏 **Reglas no-negociables (arquitectura, NFRs, alcance):** [`constitution.md`](./constitution.md)
- 🏛️ **Diseño arquitectónico completo (IDesign residual):** [`addl/docs/architect/residual-design.md`](./addl/docs/architect/residual-design.md)
- 🔌 **Contrato de la API (OpenAPI):** [`openapi.json`](./openapi.json) · Swagger UI en `/api/docs`
- 🧭 **Flujo de trabajo para cambios:** skill `keru-feature` (docs-first)
